...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_CYAN = SET_TEXT_COLOR + "51m"; // I added this color
    ...
    public static final String SET_BG_COLOR_LIGHT_TAN = SET_BG_COLOR + "180m"; // I added these two colors
    public static final String SET_BG_COLOR_DARK_TAN = SET_BG_COLOR + "94m"; // (this is the other color)
